          ...
          {heroSlides.map((slide) => (
            <CarouselItem key={slide.title}>
              <div className="container px-4 md:px-6">
                <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:gap-16 items-center bg-card/50 backdrop-blur-xl border rounded-2xl p-8 md:p-12 shadow-2xl shadow-accent/20">
