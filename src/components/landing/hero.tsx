  ...
  return (
    <section id="hero" className="w-full py-12 md:py-16">
       <Carousel
        ...
        <CarouselPrevious className="absolute left-4 top-1/2 -translate-y-1/2 z-10 hidden h-10 w-10 bg-background/50 hover:bg-background/75 sm:flex hover:!translate-y-0" />
        <CarouselNext className="absolute right-4 top-1/2 -translate-y-1/2 z-10 hidden h-10 w-10 bg-background/50 hover:bg-background/75 sm:flex hover:!translate-y-0" />
      </Carousel>
    </section>
  );
}
