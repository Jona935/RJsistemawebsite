      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
          ...
          <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            Nos asociamos con empresas innovadoras para ofrecer resultados excepcionales e impulsar la transformación digital.
          </p>
        </div>
        <Carousel
        ...
        >
          ...
          <CarouselPrevious className="hidden sm:flex hover:!translate-y-0" />
          <CarouselNext className="hidden sm:flex hover:!translate-y-0" />
        </Carousel>
      </div>
    </section>
  );
