...
export async function sendTestNotification() {
  ...
  try {
    console.log('Intentando enviar notificación de prueba a través de la plantilla "nueva_entrada" con los siguientes datos:', JSON.stringify(testLeadData, null, 2));
